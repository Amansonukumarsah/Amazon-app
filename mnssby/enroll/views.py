...
def dashboard(request):
    return render(request,'enroll/dashboard.html',{'active':'btn-primary'})

#contact

def contact(request):
    return render(request,'enroll/contact.html',{'active':'btn-primary'})
...
def user_register(request):
    if request.method=="POST":
        ...
        form=signup()
    return render(request,'enroll/register.html',{'fm':form,'active':'btn-primary'})
